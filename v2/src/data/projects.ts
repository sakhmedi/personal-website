export interface Project {
  ...
  /**
   * Что положить в localStorage сайта до загрузки. Нужно тем работам,
   * где язык или другое состояние хранится в браузере, а не в адресе:
   * без этого снимок зависел бы от того, что осталось с прошлого раза.
   */
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    screenshotUrl: "https://bloomings.netlify.app/pages/species/orchidaceae.html",
    image: "bloom.png",
    imageAlt: "Страница орхидей в справочнике Bloom с фотографией цветка",
    featured: false,
  },
];
