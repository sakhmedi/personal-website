...
Карточки собираются компонентом `src/components/Cards.astro`.
Чтобы добавить работу, вставь ещё один `<Cards title="..." description="..." />`
в `src/pages/projects.astro` (полный список) и, если работа должна попасть
на главную, в `src/pages/index.astro`.
